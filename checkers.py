...
class jogo():
	...
	def desenha_jogo(self):
		...
		# Escrevendo textos da tela do jogo.
		
		pygame.font.init()					# Configurando fonte
		font = pygame.font.get_default_font()
		font_placar = pygame.font.SysFont(font, 100)
		font_placares = pygame.font.SysFont(font, 50)
		
		mensagem_placar = 'PLACAR:'
		mensagem_placar_azul = 'AZUL:  ' + str(self.pontos_azul)
		mensagem_placar_vermelho = 'VERMELHO:  ' + str(self.pontos_vermelho)
		mensagem_turno = 'TURNO:'
		
		texto_placar = font_placar.render(mensagem_placar, 1, cor_branca)
		texto_turno = font_placar.render(mensagem_turno, 1, cor_branca)
		texto_placar_azul = font_placares.render(mensagem_placar_azul, 1, cor_branca)
		texto_placar_vermelho = font_placares.render(mensagem_placar_vermelho, 1, cor_branca)
		
		tela.blit(texto_placar, (830,30))
		tela.blit(texto_placar_azul, (830, 120))
		tela.blit(texto_placar_vermelho, (830, 170))
		tela.blit(texto_turno, (830, 300))
		...
		# Adicionando retangulo referente ao turno.
		ret_turno = pygame.Rect(920, 400, 100, 100)
		pygame.draw.rect(tela, cor_pos, ret_turno)
	...
	def analisa_click(self, (x, y)):		
		...
		elif (indice, indice2) not in self.lista_pos_indice:
			self.peca_selecionada = None
			self.lista_pos = []
			self.lista_pos_indice = []
			self.destino = None
